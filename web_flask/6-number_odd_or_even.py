...
/python/<text>, /number/<int:n>, /number_template/<int:n>, and
...
def variable_rule_nbr_odd_or_even(n):
    """This function implements for the route '/number_odd_or_even/<int:n>'"""
    p = 'even' if n % 2 == 0 else 'odd'
    return render_template('6-number_odd_or_even.html', number=n, prop=p)
